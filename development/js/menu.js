...
// 	const menuSvgRightEnd = document.querySelector('#menu-svg-right-end').getAttribute('d');
// 	const menuSvgRightStart = document.querySelector('#menu-svg-right-start').getAttribute('d');
// 	const menuSvgLeftEnd = document.querySelector('#menu-svg-left-end').getAttribute('d');
// 	const menuSvgLeftStart = document.querySelector('#menu-svg-left-start').getAttribute('d');

// 	const svgBg = document.querySelector('#menu-svg-container');
// 	svgBg.style.height = svgBg.style.width + 'px';

// 	const tweenRightIn = KUTE.fromTo('#menu-svg-right-start', {path: menuSvgRightStart }, { path: menuSvgRightEnd },{ // options
// 		easing: 'easingCubicInOut', 
// 		duration: 1000});
// 	const tweenLeftIn = KUTE.fromTo('#menu-svg-left-start', {path: menuSvgLeftStart }, { path: menuSvgLeftEnd },{ // options
// 		easing: 'easingCubicInOut', 
// 		duration: 1000});

// 		const tweenRightOut = KUTE.fromTo('#menu-svg-right-start', {path: menuSvgRightEnd }, { path: menuSvgRightStart },{ // options
// 			easing: 'easingCubicInOut', 
// 			duration: 1000});
// 		const tweenLeftOut = KUTE.fromTo('#menu-svg-left-start', {path: menuSvgLeftEnd }, { path: menuSvgLeftStart },{ // options
// 			easing: 'easingCubicInOut', 
// 			duration: 1000});
...
// 		if(!$('body').hasClass('menu-transition')) {
// 			$('body').addClass('menu-transition');
// 			$('#menu-svg-container').fadeIn();
...
// 			setTimeout(() => {
// 				$('#menu-svg-container').attr('class', 'menu-svg-line-visible');
...
// 	});
// 	$(document).on('click', '.btn-menu-cross', function(){
// 		if(!$('body').hasClass('menu-transition')) {
// 			$('body').addClass('menu-transition');
...
// 			tweenRightOut.start();
// 			tweenLeftOut.start();
// 			$('#menu-svg-container').attr('class', 'menu-svg-line-hidden');
// 			setTimeout(() => {
// 				$('#menu-svg-container').fadeOut();
// 				$('body').removeClass('menu-transition');
// 			}, 1000);
// 		}
...
jQuery(document).ready(function($){
	...
	setTimeout(() => {
        ...
        var svg = document.getElementById("menu-svg-container");
        var s = Snap(svg);

        var menuSvgRightStart = Snap.select('#menu-svg-right-start');
        var menuSvgRightEnd = Snap.select('#menu-svg-right-end');

        var menuSvgRightStartPoints = menuSvgRightStart.node.getAttribute('d');
        var menuSvgRightEndPoints = menuSvgRightEnd.node.getAttribute('d');

        var menuSvgLeftStart = Snap.select('#menu-svg-left-start');
        var menuSvgLeftEnd = Snap.select('#menu-svg-left-end');

        var menuSvgLeftStartPoints = menuSvgLeftStart.node.getAttribute('d');
        var menuSvgLeftEndPoints = menuSvgLeftEnd.node.getAttribute('d');


        var rightShow = function(){
            menuSvgRightStart.animate({ d: menuSvgRightEndPoints }, 1000, mina.easeinout);  
        }

        var rightHide = function(){
            menuSvgRightStart.animate({ d: menuSvgRightStartPoints }, 1000, mina.easeinout); 
        }

        var leftShow = function(){
            menuSvgLeftStart.animate({ d: menuSvgLeftEndPoints }, 1000, mina.easeinout);  
        }

        var leftHide = function(){
            menuSvgLeftStart.animate({ d: menuSvgLeftStartPoints }, 1000, mina.easeinout); 
        }
        ...
        // var menuSvgRightStartPoints = menuSvgRightStart.node.getAttribute('d');
        // var menuSvgRightEndPoints = menuSvgRightStart.node.getAttribute('d');
        // var menuSvgLeftStartPoints = menuSvgRightStart.node.getAttribute('d');
        // var menuSvgLeftEndPoints = menuSvgRightStart.node.getAttribute('d');

        // $('#menu-svg-container').fadeIn();


        // var toFancy = function(){
        //     menuSvgRightStart.animate({ d: menuSvgRightEndPoints }, 1000, mina.backout, toSimple);  
        // }

        // var toSimple = function(){
        //     menuSvgRightStart.animate({ d: menuSvgRightStartPoints }, 1000, mina.backout, toFancy); 
        // }
